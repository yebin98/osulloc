...
public class ReplyReviewController {
	...
	public ResponseEntity<String> create(@RequestBody ReplyReviewDTO rdto){
		...
		//insert 성공시 ReplyServiceImpl.java로 부터 1, insert 실패시 ReplyServiceImpl.java로 부터 0 값을 리턴받는다.
	...
	public ResponseEntity<String> update(@RequestBody ReplyReviewDTO rdto){
	...
	public ResponseEntity<String> remove(@RequestBody ReplyReviewDTO rdto){
